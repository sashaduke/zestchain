...
export type ZestchainMsgPromoClickedResponse = object;

export type ZestchainMsgPromoViewedResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryPromoAll = (
    ...
    this.request<ZestchainQueryAllPromoResponse, RpcStatus>({
      path: `/cytruslabs/zestchain/zestchain/promo`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   */
  queryPromo = (index: string, params: RequestParams = {}) =>
    this.request<ZestchainQueryGetPromoResponse, RpcStatus>({
      path: `/cytruslabs/zestchain/zestchain/promo/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   */
  queryPromoCount = (params: RequestParams = {}) =>
    this.request<ZestchainQueryGetPromoCountResponse, RpcStatus>({
      path: `/cytruslabs/zestchain/zestchain/promo_count`,
      method: "GET",
      format: "json",
      ...params,
    });
